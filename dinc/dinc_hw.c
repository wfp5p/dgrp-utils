...
static char dinc_hw_sccs[] =
	"@(#) $Id: dinc_hw.c,v 1.16 2005/04/01 05:17:39 scottk Exp $ Copyright (C) 1995-1998 Digi International Inc., All Rights Reserved";
...
#if defined(SOLARIS) || defined(SUNOS) || defined(LINUX) || defined(OPENBSD) || defined(SCO) || defined(SCO6) || defined(TRU64)
